...
# A2A debug, only for locating all_to_all failure.
# export MEGATRON_A2A_DEBUG=1
# export MEGATRON_A2A_DEBUG_LIMIT=10000
export MEGATRON_MOE_A2A_PAD_ZERO_SPLITS=1
# export MEGATRON_A2A_DEBUG_RANKS=0,8,17,25,27,31
