...
export PROFILER_RECORD_SHAPES=1
export PROFILER_PROFILE_MEMORY=0
export PROFILER_WITH_STACK=1
export PROFILER_WITH_MODULES=0
export PROFILER_SAVE_DIR=$WORK_HOME/profiler_traces/$RDZV_ID/$EXPNAME/$NODE_RANK
